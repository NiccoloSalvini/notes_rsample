...
1. Fit the model to the data $$y_1,...,y_t$$ and let $$\hat{y}_{t+1}$$ denote the forcast of the next observation.Then compute the error $$\tilde{e}_{t+1} = y_{t+1} -\hat{y}_{t+1}$$ for the forecast observation. 
1. Repeat step 1 for $$t = m,...,n-1$$ where m is the minimum number of observations needed for fitting the model
